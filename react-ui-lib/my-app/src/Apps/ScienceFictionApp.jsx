...
const books=[
    ...
    {image: "/science_fiction/la_guerra_de_los_mundos.webp", 
      ...
      author: "H. G. Wells", 
      description:'La invasión de la Tierra por marcianos con tecnología avanzada pone a prueba la supervivencia de la humanidad en esta obra clásica de ciencia ficción.' }
    ];   
